...
def parse_args():
    parser = argparse.ArgumentParser(description="Calculate BLEU Scores for GeoChat")
    parser.add_argument("--model-path", type=str, default="geochat-7B", help="Path to the model weights")
    parser.add_argument("--model-base", type=str, default=None)
    parser.add_argument("--data-file", type=str, required=True, help="Path to your validation dataset (JSON)")
...
def load_model(args):
    ...
    # --- CRITICAL FIX 1: Force Vision Tower to Float32 ---
    # This prevents the "compute_indices_weights_cubic" error
...
def main():
    ...
    for item in tqdm(data):
        ...
        # Extract Human Question and Ground Truth Answer
        ...
        # --- CRITICAL FIX 2: Autocast Generation ---
        # This prevents the "expected scalar type Float but found Half" error
